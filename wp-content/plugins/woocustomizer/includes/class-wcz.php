...
class WooCustomizer
{
    ...
    function wcz_feedback_notice()
    {
        ...
        if ( current_user_can( 'manage_options' ) && !get_user_meta( $wcz_user_id, 'wcz_feedback_notice_dismiss' ) ) {
            ...
            printf( esc_html__( '(Soon changing to "%1$s")', 'woocustomizer' ), wp_kses( '<b>StoreCustomizer</b>', array(
                'b' => array(),
            ) ) );
            ?>
                    </span>
            ...
            ?></h5>
						<div class="wcz-notice-cont">
							<p><?php 
            esc_html_e( 'This means you\'re one of the early users to find and use the WooCustomizer plugin... If WooCustomizer doesn\'t work perfectly with your theme right away, I\'ll sure try make it work for you!', 'woocustomizer' );
            ?></p>
						</div>
						<a href="<?php 
            ...
            ?>" class="wcz-notice-btn">
							<?php 
            esc_html_e( 'Go To WooCustomizer Settings', 'woocustomizer' );
            ?>
						</a>
						<a href="<?php 
            ...
            ?>" target="_blank" class="wcz-notice-btn">
							<?php 
            esc_html_e( 'Try out WooCustomizer PRO Settings', 'woocustomizer' );
            ?>
						</a>
					</div>
					<div class="wcz-notice-col">
            ...
            printf( esc_html__( '%1$s, am here to help, and fix any bugs that come up, manage support & development, and also adding the new features you want.', 'woocustomizer' ), wp_kses( '<a href="https://woocustomizer.com/go/about/" class="wcz-admin-notice-a" target="_blank">' . __( 'I, Zack', 'woocustomizer' ) . '</a>', array(
                'a' => array(
                'href'   => array(),
                'class'  => array(),
                'target' => array(),
            ...
            ?></h5>
						<div class="wcz-notice-cont">
							<p><?php 
            esc_html_e( 'If the plugin works well for you or our support was good... giving WooCustomizer a nice review would really help with motivation & giving other users trust in my work.', 'woocustomizer' );
            ?></p>
                        </div>
                        <div class="wcz-notice-rating-btns">
                            <div class="wcz-notice-rating-btn wcz-notice-rating-click">
                                <?php 
            esc_html_e( 'Ok, I\'ll rate WooCustomizer!', 'woocustomizer' );
            ?>
                            </div>
