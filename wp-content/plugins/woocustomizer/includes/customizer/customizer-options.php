...
function woocustomizer_customizer_library_options()
{
    ...
    if ( WooCustomizer::wcz_is_plugin_active( 'woocommerce.php' ) ) {
        ...
        $options['wcz-add-price-prefix'] = array(
            ...
            'section'     => $section,
            'type'        => 'checkbox',
            'description' => __( 'Edit the prefix per product under Product Data -> WooCustomizer on each product', 'woocustomizer' ),
            'default'     => 0,
        );
        ...
        $options['wcz-add-price-suffix'] = array(
            ...
            'section'     => $section,
            'type'        => 'checkbox',
            'description' => __( 'Edit the suffix per product under Product Data -> WooCustomizer on each product', 'woocustomizer' ),
            'default'     => 0,
        );
