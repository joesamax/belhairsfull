...
class WooCustomizer_Settings {
	...
	private function settings_fields() {
		...
		if ( ! wcz_fs()->can_use_premium_code() ) {
			...
			$settings['wcz_general'] = array(
				...
				'description' => '<b>Note:</b> All settings for WooCustomizer are built into the WordPress Customizer.<br />Please go to <b>Appearance -> Customize -> WooCustomizer</b>',
				'fields'      => array(
					array(
						'id'          => 'set_general_tour',
			...
			$settings['wcz_handheld_footer'] = array(
				...
				'fields'      => array(
					array(
						...
						'type'        => 'promo',
                        'default'     => '',
                        'top_txt' => __( 'Your users can easily search for products, proceed to checkout, or view their account pages from anywhere within your store when on mobile or tablet devices. WooCustomizer Pro gives you a neat footer navigation bar for handheld devices. Plus you are able to further customize the footer navigation bar to suit your website design.', 'woocustomizer' ),
					),
				),
			);
		...
		if ( wcz_fs()->can_use_premium_code() ) {
			...
			$settings['wcz_general'] = array(
				'title'       => __( 'General Settings', 'woocustomizer' ),
				'description' => __( '<b>Note:</b> All settings for WooCustomizer are built into the WordPress Customizer.<br />Please go to <b>Appearance -> Customize -> WooCustomizer</b>' ),
				'fields'      => array(
					array(
						'id'          => 'set_general_tour',
						'label'       => __( 'Turn off the Customizer Tour', 'woocustomizer' ),
	...
	public function settings_page() {
        ...
        $html 	.= '<h4 class="wcz-temp-heading">' . __( 'WooCustomizer will soon be changing it\'s name to ', 'woocustomizer' ) . '"<span>' . __( 'StoreCustomizer', 'woocustomizer' ) . '</span>"</h4>' . "\n";
