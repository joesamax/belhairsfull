...
include_once(__DIR__ . '/functions/wshk-dynamic-navigation-menu.php');//OK
include_once(__DIR__ . '/functions/wshk-customize-shop-page.php'); //OK
include_once(__DIR__ . '/functions/wshk-build-myaccount-page.php'); //OK
include_once(__DIR__ . '/functions/wshk-counters.php'); //OK
include_once(__DIR__ . '/functions/wshk-additional-shortcodes.php');//OK
include_once(__DIR__ . '/functions/wshk-restrict-content.php'); //OK
include_once(__DIR__ . '/functions/wshk-wc-additional-settings.php');//OK
include_once(__DIR__ . '/functions/wshk-adapt-to-gdpr.php');//OK
include_once(__DIR__ . '/functions/wshk-add-security.php');//OK
