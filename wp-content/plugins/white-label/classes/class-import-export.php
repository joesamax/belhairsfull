...
class white_label_Import_Export_Options {
	...
	public function __construct() {
		...
		add_action( 'admin_init', array( $this, 'process_settings_import' ), 50 );
		add_action( 'admin_init', array( $this, 'process_settings_export' ), 50 );
	}
	...
	<div class="white_label-subsection">
