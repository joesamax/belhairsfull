...
$fields[] = array(
    ...
    'section'     => 'general',
    'label'       => esc_html__( 'Force showing add to cart button on shop archive page', 'woo-floating-cart' ),
    'description' => esc_html__( 'Some themes do not show the add to cart button on the catalog. (ex: Divi theme) This will force it to show.', 'woo-floating-cart' ),
    'type'        => 'radio-buttonset',
    'choices'     => array(
    '0' => esc_html__( 'No', 'woo-floating-cart' ),
    '1' => esc_html__( 'Yes', 'woo-floating-cart' ),
...
$fields[] = array(
    'id'       => 'trigger_hide_view_cart',
    'section'  => 'general',
    'label'    => esc_html__( 'Hide "View Cart" Link after add to cart', 'woo-floating-cart' ),
    'type'     => 'radio-buttonset',
    'choices'  => array(
    '0' => esc_html__( 'No', 'woo-floating-cart' ),
    '1' => esc_html__( 'Yes', 'woo-floating-cart' ),
