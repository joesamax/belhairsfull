...
if ( ! class_exists( 'Xirki_Control_XTFW_Icons' ) && class_exists( 'Xirki_Control_Base' ) ) {
	...
	class Xirki_Control_XTIcons extends Xirki_Control_Base {
		...
		public function enqueue() {
            ...
            wp_enqueue_style( 'xt-icons', plugin_dir_url( __FILE__ ) . 'css/xt-icons.css', array(), '1.0.0' );

			wp_enqueue_style( 'xirki-xt-icons', plugin_dir_url( __FILE__ ) . 'css/xt-icons-control.css', array(), '1.0.0' );
			wp_enqueue_script( 'xirki-xt-icons', plugin_dir_url( __FILE__ ) . 'js/xt-icons-control.js', array(), '1.0.0' );
		}
