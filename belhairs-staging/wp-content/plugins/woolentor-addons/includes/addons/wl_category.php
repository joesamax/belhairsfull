        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'description'   => wp_kses_post( 'Vertical layout are available in the pro version. (<a href="'.esc_url('https://hasthemes.com/1ziu').'" target="_blank">Get Pro</a>)', 'woolentor' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<div class="elementor-nerd-box">' .
                            ...
                            '</div>
                            <a class="elementor-nerd-box-link elementor-button elementor-button-default elementor-go-pro" href="' . esc_url( 'https://hasthemes.com/1ziu' ) . '" target="_blank">' .
                                __( 'Go Pro', 'woolentor' ) .
                            '</a>
                            </div>',
                ]
