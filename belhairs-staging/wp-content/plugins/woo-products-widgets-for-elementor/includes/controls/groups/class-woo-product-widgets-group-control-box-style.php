...
class Woo_Product_Widgets_Group_Control_Box_Style extends Elementor\Group_Control_Base {

	protected static $fields;

	public static function get_type() {
		return 'woo-products-widgets-box-style';
	}
	...
	protected function init_fields() {
		...
		$fields['box_font_color'] = array(
			'label'     => esc_html__( 'Font Color', 'woo-product-widgets-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
		...
		$fields['box_font_size'] = array(
			'label'      => esc_html__( 'Font Size', 'woo-product-widgets-for-elementor' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', 'rem',
			),
		...
		$fields['box_size'] = array(
			'label'      => esc_html__( 'Box Size', 'woo-product-widgets-for-elementor' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', '%',
			),
		...
		$fields['box_border'] = array(
			'label'   => _x( 'Border Type', 'Border Control', 'woo-product-widgets-for-elementor' ),
			'type'    => Controls_Manager::SELECT,
			'options' => array(
				''       => esc_html__( 'None', 'woo-product-widgets-for-elementor' ),
				'solid'  => _x( 'Solid', 'Border Control', 'woo-product-widgets-for-elementor' ),
				'double' => _x( 'Double', 'Border Control', 'woo-product-widgets-for-elementor' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'woo-product-widgets-for-elementor' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'woo-product-widgets-for-elementor' ),
			),
			'selectors' => array(
		...
		$fields['box_border_width'] = array(
			'label'     => _x( 'Width', 'Border Control', 'woo-product-widgets-for-elementor' ),
		...
		$fields['box_border_color'] = array(
			'label' => _x( 'Color', 'Border Control', 'woo-product-widgets-for-elementor' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'selectors' => array(
		...
		$fields['allow_box_shadow'] = array(
			'label' => _x( 'Box Shadow', 'Box Shadow Control', 'woo-product-widgets-for-elementor' ),
		...
		$fields['box_shadow_position'] = array(
			'label' => _x( 'Position', 'Box Shadow Control', 'woo-product-widgets-for-elementor' ),
			'type' => Controls_Manager::SELECT,
			'options' => array(
				' '     => _x( 'Outline', 'Box Shadow Control', 'woo-product-widgets-for-elementor' ),
				'inset' => _x( 'Inset', 'Box Shadow Control', 'woo-product-widgets-for-elementor' ),
			),
			'condition' => array(
				'allow_box_shadow!' => '',
			),
