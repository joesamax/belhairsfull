...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '2.0.3' );
		...
		if ( ! class_exists( 'WPCleverWoosw' ) ) {
			class WPCleverWoosw {
				...
				function row_meta( $links, $file ) {
					...
					if ( $plugin === $file ) {
						$row_meta = array(
							'support' => '<a href="https://wpclever.net/support?utm_source=support&utm_medium=woosw&utm_campaign=wporg" target="_blank">' . esc_html__( 'Premium support', 'woosw' ) . '</a>',
						);
