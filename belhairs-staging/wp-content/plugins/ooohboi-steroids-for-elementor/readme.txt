...
= NEW ADD-ON NOW AVAILABLE - SEARCH COP =

Search Form widget now allows you to select what to search; Posts only, Pages only or both.
...
1.3.3 - Beware of the changes in the language file too
