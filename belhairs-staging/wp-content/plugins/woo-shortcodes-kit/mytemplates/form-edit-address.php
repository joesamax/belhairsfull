...
//Since 1.7.3
    ...
    } elseif ( in_array( 'easy-myaccount-builder/easy-myaccount-builder-for-wshk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
...
<?php else : ?>
<div class="wshk-add-separator" style="height: 100px;"></div>
	<form method="post">
