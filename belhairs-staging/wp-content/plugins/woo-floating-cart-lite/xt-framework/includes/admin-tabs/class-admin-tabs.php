...
if(!class_exists('XT_Framework_Admin_Tabs')) {
	...
	abstract class XT_Framework_Admin_Tabs {
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script( $this->core->framework_prefix( 'admin-tabs' ), xtfw_dir_url( XTFW_DIR_ADMIN_TABS_ASSETS ) . '/js/admin-tabs' . XTFW_SCRIPT_SUFFIX . '.js', array(), XTFW_VERSION, false );
		...
		public function show_nav_tab( $tab ) {
			...
			echo '<span class="nav-tab-title">' . sanitize_text_field( $tab['title'] ) . '</span>';
