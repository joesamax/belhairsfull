...
if(!class_exists('XT_Framework_Plugin_Settings')) {
    ...
    class XT_Framework_Plugin_Settings {
                ...
                switch ( $value['type'] ) {
                    ...
                    case 'single_select_page':
                        ...
                        <tr valign="top" class="single_select_page">
                            ...
                            <td class="forminp">
                                <?php echo str_replace( ' id=', " data-placeholder='" . esc_attr__( 'Select a page&hellip;', 'xt-framework' ) . "' style='" . $value['css'] . "' class='" . $value['class'] . "' id=", wp_dropdown_pages( $args ) ); // WPCS: XSS ok. ?> <?php echo $description; // WPCS: XSS ok. ?>
                            </td>
                        </tr>
                        <?php
                        break;
                    ...
                    case 'single_select_country':
                        ...
                        <tr valign="top">
                            ...
                            <td class="forminp"><select name="<?php echo esc_attr( $value['id'] ); ?>" style="<?php echo esc_attr( $value['css'] ); ?>" data-placeholder="<?php esc_attr_e( 'Choose a country&hellip;', 'xt-framework' ); ?>" aria-label="<?php esc_attr_e( 'Country', 'xt-framework' ); ?>" class="wc-enhanced-select">
                        ...
                        <tr valign="top">
                            ...
                            <td class="forminp">
                                <select multiple="multiple" name="<?php echo esc_attr( $value['id'] ); ?>[]" style="width:350px" data-placeholder="<?php esc_attr_e( 'Choose countries&hellip;', 'xt-framework' ); ?>" aria-label="<?php esc_attr_e( 'Country', 'xt-framework' ); ?>" class="wc-enhanced-select">
                                    ...
                                    ?>
                                </select> <?php echo ( $description ) ? $description : ''; // WPCS: XSS ok. ?> <br /><a class="select_all button" href="#"><?php esc_html_e( 'Select all', 'xt-framework' ); ?></a> <a class="select_none button" href="#"><?php esc_html_e( 'Select none', 'xt-framework' ); ?></a>
                            </td>
                        </tr>
                        <?php
                        break;
        ...
        public function enqueue_assets() {
            ...
            wp_enqueue_script( $this->core->framework_prefix('jquery-tiptip'), xtfw_dir_url( XTFW_DIR_ASSETS ) . '/js/jquery.tiptip'.XTFW_SCRIPT_SUFFIX.'.js', array( 'jquery', 'jquery-ui-datepicker', 'jquery-ui-accordion'), XTFW_VERSION, false );
